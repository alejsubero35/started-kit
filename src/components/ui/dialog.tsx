...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // Mobile: use inset-4 so dialog sits away from all viewport edges and
        // can grow up to the viewport width minus padding. Desktop (sm+) will
        // use absolute centering with a fixed max width.
