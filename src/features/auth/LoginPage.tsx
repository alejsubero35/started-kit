    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#103B73]/5 via-background to-[#F2811D]/10 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-6">
        <div className="text-center space-y-3">
          <img src={assetUrl('img/logo.png')} alt="IDENNA" className="mx-auto h-24 w-full max-w-sm object-contain" />
          <h1 className="text-2xl font-bold text-[#103B73] tracking-tight">SIRP-NNA</h1>
        </div>

        <Card className="border-t-4 border-t-[#103B73] shadow-lg">
        ...
        <div className="text-center space-y-1 px-2">
          ...
          <p className="text-xs text-muted-foreground/80">IDENNA · Venezuela</p>
        </div>
      </div>
    </div>
  );
